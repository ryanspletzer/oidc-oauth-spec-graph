...
graph LR
  ...
  subgraph OAuth_2_0_RFCs
    ...
    UMA_Profile["User-Managed Access (UMA) Profile of OAuth 2.0"]
  ...
  click UMA_Profile "https://docs.kantarainitiative.org/uma/rec-uma-core.html" "User-Managed Access (UMA) Profile of OAuth 2.0"
